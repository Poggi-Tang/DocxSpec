...
from src.docxspec.word_api import WordAPI
from src.docxspec.word_styles import (
    BODY_STYLE,
    CAPTION_STYLE,
    MAIN_STYLE,
    TABLE_BODY_STYLE,
...
def main() -> None:
    ...
    template_path = project_root / "src" / "docxspec" / "templates" / "default_template.docx"
    image_path = project_root / "src" / "docxspec" / "templates" / "klword.png"
